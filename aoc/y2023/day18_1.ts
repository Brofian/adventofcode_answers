...
class Y2023_Day18_1 extends AbstractRiddle {

    riddle: string = "What is the area that was dug out when following the instructions?";
    ...
    run(): number {
        ...
        const instructions: Instruction[] = this.readInput().map(line => {
            ...
            return {
                direction: matches[1] as ValidDirection,
...
export default (new Y2023_Day18_1());
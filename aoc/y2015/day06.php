...
class day06 extends AbstractRiddle {
    ...
    function getRiddleDescriptionA(): string
    {
        return 'After following the instructions, how many lights are lit?';
    }

    function getRiddleAnswerA(): string
    {
